...
async function init() {
  ...
  await db.defaults({
    ...
    ratings :[
      { userId: 'OOWzUaHLsK', butterflyId: 'GI9_EuH8s1', rating: 4 },
      { userId: 'OOWzUaHLsK', butterflyId: 'xRKSdjkBt4', rating: 5 },
      { userId: 'sdmU7-wkQX', butterflyId: '0MUBKMu07U', rating: 3 },
      { userId: 'aqekk3t4kw', butterflyId: 'NLktii5zvK', rating: 2 },
      { userId: 'aqekk3t4kw', butterflyId: 'SMyaT24g-N', rating: 5 },
      { userId: 'sdmU7-wkQX', butterflyId: 'DCenP4kQNQ', rating: 4 }
    ]
